...
from code.INFEREM import INFEREM
...
def load_params():
    ...
    parser.add_argument("--dataset", type=str, default="INFEREM-main/data/kemp_dataset_preproc.json", help='processed EmpatheticDialogue dataset')
    ...
    parser.add_argument("--emb_file", type=str, default='INFEREM-main/data/glove.6B.300d.txt', help='path to glove embedding file')
    parser.add_argument("--model", type=str, default="InFEREM", help='model name, [InFEREM, KEMP]')
    ...
    parser.add_argument('--device_id', dest='device_id', type=str, default="1", help='gpu device id')
    ...
    parser.add_argument("--noam", default=True, help='NoamOpt')
    ...
    parser.add_argument("--pretrain_emb", default=True, help='use pretrained embedding (glove) or not')
    parser.add_argument("--weight_sharing", action="store_true", help='sharing params between input embedding and output proj')
    parser.add_argument("--label_smoothing", default=True, help='label smoothing loss')
    ...
    parser.add_argument("--train_then_test", default=True, help='test model if the training finishes')
    ...
    parser.add_argument("--hop", type=int, default=3, help='number of transformer layers')
    ...
    parser.add_argument("--concept_num", type=int, default=1, help='the maximum number of external concepts injection for a word.')
    ...
    parser.add_argument("--pointer_gen", default=True, help='copy mechanism')
    parser.add_argument("--attn_loss", default=True, help="emotional attention loss")
...
if __name__ == '__main__':
    ...
    model = INFEREM(args, vocab, decoder_number=program_number)
